...
import iducs.springboot.boardpsh.entity.QBoardEntity;
import iducs.springboot.boardpsh.entity.QMemberEntity;
import iducs.springboot.boardpsh.entity.QReplyEntity;
            ...
            for(String t : typeArr) {
                switch (t) {
                    ...
                    case "c":
                        ...
                        break;
                    case "m":
                        conditionBuilder.or(memberEntity.mobile.substring(9, 12).contains(keyword)); // 게시물 내용
                        break;
                }
            }
